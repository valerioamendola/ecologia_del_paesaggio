...
# PER L'INSTALLAZIONE DI UN PACCHETTO SI UTILIZZANO LE VIRGOLETTE PERCHÈ SI FA DIALOGRARE R CON L'ESTERNO.
install.packages("sp")

# UNA VOLTA INSTALLATO UN PACCHETTO, SI POSSONO RICHIAMARE LE LIBRERIE, CIOÈ BLOCCHI DI FUNZIONI CHE POSSONO ESSERE IMPORTATE SU R 
# ATTRAVERSO IL COMANDO library(). NEL CASO SPECIFICO IL PACCHETTO SP RIGUARDA I DATI SPAZIALI.

library(sp)

# require(sp) è un altro comando per far partire le librerie.

# MEUSE È UN DATASET DISPONIBILE ALL'INTERNO DELL PACCHETTO SP
